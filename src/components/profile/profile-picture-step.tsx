...
import { UploadCloud, User as UserIcon, Loader2, Trash2 } from 'lucide-react';
import { OnboardingData } from '../onboarding/onboarding-flow';
...
export function ProfilePictureStep({ data, onDataChange, onNext, onBack }: ProfilePictureStepProps) {
  ...
  const handleRemovePicture = () => {
    ...
    toast({
      ...
      description: 'Your profile picture has been removed. A default avatar will be used.'
    });
  }
    ...
    <Card>
      ...
      <CardContent className="flex flex-col items-center gap-6">
        ...
        <div className="w-full flex flex-col sm:flex-row gap-2">
            ...
            {preview && (
                 <Button type="button" variant="destructive" className="w-full sm:w-auto" onClick={handleRemovePicture}>
