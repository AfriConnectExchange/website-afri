                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style={{ padding: "28px 28px 8px 28px" }}>
                          ...
                          <Text style={text}>We're pleased to confirm that your order <strong>{orderNumber}</strong> was delivered on {deliveryDate}.</Text>
                          <Text style={text}>We hope you love your purchase! Please take a moment to share your experience by leaving a review.</Text>
